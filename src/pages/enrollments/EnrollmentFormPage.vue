...
// Pré-remplissage depuis la liste des élèves ou après la création d'un élève
    const preselectedId = route.query.studentId
    if (preselectedId && !isEdit && !form.studentId) {
      form.studentId = Number(preselectedId)
    }
  } catch (e) {
