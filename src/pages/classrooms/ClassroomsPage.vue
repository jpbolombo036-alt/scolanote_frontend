  ...
  <div class="space-y-6 font-['Plus_Jakarta_Sans',sans-serif]">
    ...
    <div class="bg-white dark:bg-[#0d1527] border border-slate-200/80 dark:border-slate-800 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-xl overflow-hidden transition-colors duration-200">
      ...
      <div v-if="loading" class="py-16 text-center">
        ...
        <p class="text-xs text-slate-400 font-medium mt-3">Chargement des classes...</p>
      </div>

      <!-- Table Content -->
      <div v-else-if="filteredClassrooms.length > 0" class="overflow-x-auto">
      ...
      <!-- Empty State -->
      <EmptyState v-else message="Aucune classe trouvée" />
