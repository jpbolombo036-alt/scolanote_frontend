  ...
  <div v-if="visible" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold">{{ student ? 'Modifier' : 'Créer' }} un élève</h2>
      ...
      <form @submit.prevent="onSubmit">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input v-model="form.matricule" type="text" required class="w-full border rounded-lg px-3 py-2" />
          </div>
          <div>
          ...
          <div>
            ...
            <select v-model="form.sexe" class="w-full border rounded-lg px-3 py-2">
          ...
          <div>
            ...
            <input v-model="form.dateNaissance" type="date" class="w-full border rounded-lg px-3 py-2" />
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Lieu de naissance</label>
            <input v-model="form.lieuNaissance" type="text" class="w-full border rounded-lg px-3 py-2" />
          </div>
          ...
          <div>
            ...
            <input v-model="form.telephoneParent" type="text" class="w-full border rounded-lg px-3 py-2" />
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Email parent</label>
            <input v-model="form.emailParent" type="email" class="w-full border rounded-lg px-3 py-2" />
          </div>
        </div>
